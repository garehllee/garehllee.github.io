...
function checkScroll(){
    let compscroll = getComputedStyle(document.body).getPropertyValue('--colorturnpointMM');
    let compscroll2 = getComputedStyle(document.body).getPropertyValue('--colorturnpointMM2');
